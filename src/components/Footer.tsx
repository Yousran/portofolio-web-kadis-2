      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="grid grid-cols-2 gap-8 md:justify-items-end">
            ...
            <div className="space-y-4">
              <h4 className="font-bold text-sm uppercase tracking-widest text-white">Legal</h4>
              <ul className="space-y-2 text-sm text-gray-400">
                <li className="hover:text-brand-primary transition-colors cursor-pointer">Privacy Policy</li>
                <li className="hover:text-brand-primary transition-colors cursor-pointer">Terms of Service</li>
              </ul>
            </div>
          </div>
        </div>
